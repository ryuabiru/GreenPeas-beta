...
このベータ版は正式リリース前のため、macOS で開くと「開発元を確認できません」と表示される場合があります。

ダウンロード元がこの公式 GitHub Release ページであることを確認してから開いてください。

必要な方は、以下の SHA-256 checksum でダウンロードした DMG を確認できます。
