...
- DNA 配列ファイルを開く、編集する
- GenBank 系ファイルや一般的な DNA 配列編集ワークフローを扱う
- 配列をリニア表示やマップ表示で確認する
...
GreenPeas で開いた配列ファイルや作業データは、通常の利用においてローカル環境内で処理され、開発者へ自動送信されることはありません。

ただし、ユーザーがフィードバックやバグ報告のためにメールでファイルや内容を送付した場合は、その送付内容を確認することがあります。
